    ...
    try {
        fetch(apiUrl)
            ...
            .then(function (jsonResponse) {
                ...
                total_bikes_chart.data.labels = jsonResponse.labels;
                total_bikes_chart.data.datasets[0].data = jsonResponse.values;

                // Update the chart ticks according to the selected span
                total_bikes_chart.options.scales.x.ticks.callback = function(value, index, values) {
